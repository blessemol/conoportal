  ...
  function AlertToastMini(type, msgPosition, msgNotif) {
      if (type == 'success') {
          var iconIndicator = 'icon ion-checkmark-circled';
      } else if (type == 'error') {
          var iconIndicator = 'icon ion-close-circled';
      } else if (type == 'warning') {
          var iconIndicator = 'icon ion-android-warning';
      } else if (type == 'info') {
          var iconIndicator = 'icon ion-information-circled';
      }
      Lobibox.notify(type, {
          pauseDelayOnHover: true,
          rounded: true,
  ...
  function AlertToastMaxi(type, msgPosition, msgNotif) {
      if (type == 'success') {
          var iconIndicator = 'fa fa-check-circle';
      } else if (type == 'error') {
          var iconIndicator = 'fa fa-times-circle';
      } else if (type == 'warning') {
          var iconIndicator = 'fa fa-exclamation-triangle';
      } else if (type == 'info') {
          var iconIndicator = 'fa fa-info-circle';
      }
      Lobibox.notify(type, {
          pauseDelayOnHover: true,
          rounded: true,
