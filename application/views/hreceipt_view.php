							...
							<div class="page-title-heading">
								<div class="col-md-12">
									...
									<div style="float: left; text-align: left !important;">
										...
										<div style="margin: 0px; font-size: 14px;"><strong>Accommodation Fee Payment Receipt - <?php print $paydet['sess']; ?> Academic Session</strong></div>
									</div>
								</div>
							...
							<div class="main-card mb-3 card">
								<div class="card-body">
									...
									if($status=="paid"){
										...
										<h6 style="margin-top: 10px;"><strong>Payment Details</strong></h6>
										<p>Order ID: <?php print $orderid; ?></p>
										<p style="font-weight: bold;">RRR: <?php print $rrr; ?></p>
										<p>Amount: <?php print number_format($amount, 2); ?></p>
										<p>Payment Platform: REMITA</p>
										<div class="divider"></div>
										<br>_____________________________________<br>
										<strong>Bursar (Signature &amp; Date)</strong><br>
										<img src="<?php print base_url('assets/images/remita.png'); ?>" height="50px;"><br><br>
